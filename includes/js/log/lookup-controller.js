...
LookupController.prototype.lookupComment = function( id ) {
	var objSelf = this;
	var req = $.ajax({
		type: 'GET',
...
LookupController.prototype.lookupCommentDone = function(data, textStatus, jqXHR) {
	var objSelf = this;
...
LookupController.prototype.lookupCommentFail = function(jqXHR, textStatus, errorThrown) {
	alert('Error Looking up');
};

$(function() { new LookupController(); });
